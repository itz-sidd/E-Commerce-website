      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary-400 mb-4">ShopStore</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=Electronics" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Electronics
                </Link>
              </li>
              <li>
                <Link to="/products?category=Clothing" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Clothing
                </Link>
              </li>
              <li>
                <Link to="/products?category=Home & Garden" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Home & Garden
                </Link>
              </li>
            </ul>
